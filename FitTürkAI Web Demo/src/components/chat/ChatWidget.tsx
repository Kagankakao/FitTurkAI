    ...
    <div className="font-inter">
      ...
      {!fullscreen && (
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="fixed bottom-6 right-6 z-50 p-4 bg-slate-900 hover:bg-slate-800 text-white rounded-2xl shadow-sm hover:shadow-md transition-all duration-300"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`${
              fullscreen 
                ? 'fixed inset-0 z-50 bg-slate-50 dark:bg-slate-950' 
          ...
          >
            ...
            {/* Header */}
            <div className={`flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-900 border-b border-slate-200/70 dark:border-slate-800/70 ${
                  ...
                  <div className="p-4 border-b border-slate-200 dark:border-slate-700">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <motion.button
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="p-1.5 rounded-lg bg-slate-900 hover:bg-slate-800 text-white shadow-sm transition-all duration-200"
                      >
                        ...
                        <div className={`flex items-end gap-2 ${
                          ...
                          <div className={`relative px-3 py-2 rounded-2xl shadow-sm transition-all duration-200 hover:shadow-md ${
                            ...
                            <div className={`absolute bottom-0 w-2 h-2 ${
                              message.isUser 
                                ? 'right-0 translate-x-0.5 bg-slate-100 dark:bg-slate-800' 
                                : 'left-0 -translate-x-0.5 bg-white dark:bg-slate-900'
                  ...
                  {isLoading && (
                    ...
                    >
                      <div className={`flex items-end gap-2 ${
                        ...
                        <div className="w-6 h-6 bg-slate-700 rounded-full flex items-center justify-center shadow-sm">
                          <SparklesIcon className="w-3 h-3 text-white" />
                        </div>
                ...
                >
                  <div className={`flex gap-2 items-end ${
                    ...
                    <motion.button
                      ...
                      className="p-2.5 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white shadow-sm transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
